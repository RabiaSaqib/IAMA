...
const Navbar: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg hover:bg-gray-800 transition-colors duration-200 z-50 relative"
            >
      ...
      {/* Mobile Sidebar */}
      <div className={`fixed top-0 right-0 h-full w-1/2 bg-gray-950 border-l border-gray-800 z-40 transform transition-transform duration-300 ease-in-out md:hidden ${
